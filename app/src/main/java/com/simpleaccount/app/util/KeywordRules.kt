...
object KeywordRules {
    ...
    private val RULES: List<Pair<String, List<String>>> = listOf(
        "餐饮" to listOf(
            ...
            "云饺", "肠粉", "肉饼", "便利店食品", "食堂", "必胜客", "汉堡王", "华莱士", "德克士",
            "喜茶", "霸王茶姬", "茶百道", "古茗", "奈雪", "库迪", "Manner", "蜜雪", "沙县", "黄焖鸡",
            "兰州拉面", "杨国福", "张亮", "麻辣烫", "冒菜", "木屋烧烤", "喜家德", "永和大王",
            "真功夫", "老乡鸡", "西贝", "外婆家", "绿茶餐厅", "盒马鲜生餐饮", "便利蜂餐", "全家关东煮"
        ),
        "交通" to listOf(
            "滴滴", "地铁", "公交", "高铁", "火车", "机票", "加油", "停车", "打车", "出租车",
            "网约车", "顺风车", "代驾", "高速", "过路费", "出行", "哈啰", "骑行", "共享单车",
            "12306", "中铁", "铁路", "一卡通", "过闸", "乘车", "高德打车", "曹操出行", "T3出行",
            "阳光出行", "花小猪", "青桔", "美团单车", "石化", "中石油", "中石化", "壳牌",
            "停车场", "停车费", "ETC", "航空", "南航", "东航", "国航", "春秋航空", "吉祥航空"
        ),
        "购物" to listOf(
            "淘宝", "天猫", "京东", "拼多多", "超市", "便利店", "商场", "优衣库", "购物",
            "菜市场", "生鲜", "沃尔玛", "山姆", "美宜佳", "杂货", "文具店", "礼品",
            "抖音电商", "得物", "唯品会", "苏宁", "国美", "盒马", "永辉", "大润发", "华润万家",
            "罗森", "全家", "7-Eleven", "七十一", "名创优品", "无印良品", "MUJI", "ZARA",
            "H&M", "希音", "SHEIN", "小米商城", "华为商城", "苹果", "数码", "电器"
        ),
        "娱乐" to listOf(
    ...
    fun classify(text: String): String? {
        ...
        var bestLen = -1
        var bestOrd = Int.MAX_VALUE
        RULES.forEachIndexed { ord, (category, keywords) ->
            for (kw in keywords) {
                val k = kw.lowercase()
                if (k.isNotEmpty() && hay.contains(k)) {
                    val len = k.length
                    if (len > bestLen || (len == bestLen && ord < bestOrd)) {
                        bestLen = len
                        bestOrd = ord
                        bestCat = category
                    }
