...
class SettingsViewModel @Inject constructor(
    ...
    private val _visualStyle = MutableStateFlow(settingsRepository.visualStyle())
    ...
    fun setVisualStyle(id: String) {
        _visualStyle.value = id
        viewModelScope.launch { settingsRepository.setVisualStyle(id) }
    }
}
